...
import ru.practicum.shareit.exception.model.ErrorResponseForState;
...
public class ErrorHandler {
    ...
    @ExceptionHandler
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ErrorResponseForState handleStateBadRequestExceptions(final BadRequestStateException e) {
        return new ErrorResponseForState(e.getMessage());
    }
}